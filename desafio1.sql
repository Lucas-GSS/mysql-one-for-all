...
CREATE TABLE SpotifyClone.`planos` (
    ...
    `categoria_plano` VARCHAR(30) NOT NULL,
    `valor_plano` FLOAT NOT NULL
) engine = InnoDB;
INSERT INTO SpotifyClone.planos(id_plano, categoria_plano, valor_plano)
VALUES
(1, 'gratuito', "0.00"),
(2, 'familiar', "7.99"),
...
CREATE TABLE SpotifyClone.`usuarios` (
    ...
    FOREIGN KEY(`plano_usuario`) REFERENCES SpotifyClone.`planos`(`id_plano`)
) engine = InnoDB;
INSERT INTO SpotifyClone.usuarios(nome_usuario, idade_usuario, plano_usuario, data_assinatura)
VALUES
...
CREATE TABLE SpotifyClone.`albuns` (
    ...
    FOREIGN KEY(`artista`) REFERENCES SpotifyClone.`artistas`(`id_artista`)
) engine = InnoDB;
INSERT INTO SpotifyClone.albuns(nome_album, artista, ano_lancamento)
VALUES
('Envious', 1, 1990),
('Exuberant', 1, 1993),
...
CREATE TABLE SpotifyClone.`musicas` (
    ...
    FOREIGN KEY(`album`) REFERENCES SpotifyClone.`albuns`(`id_album`)
) engine = InnoDB;
INSERT INTO SpotifyClone.musicas(titulo, album, duracao_segundos)
VALUES
('Soul For Us', 1, 200),
...
CREATE TABLE SpotifyClone.`historico_reproducoes` (
    ...
    FOREIGN KEY(`usuario`) REFERENCES SpotifyClone.`usuarios`(`id_usuario`),
    FOREIGN KEY (`musica`) REFERENCES SpotifyClone.`musicas`(`id_musica`)
) engine = InnoDB;
INSERT INTO SpotifyClone.historico_reproducoes(usuario, musica, data_reproducao)
VALUES
...
CREATE TABLE SpotifyClone.`seguidores` (
    `usuario` INT NOT NULL,
    `segue_artista` INT NOT NULL,
    PRIMARY KEY (`usuario`, `segue_artista`),
    FOREIGN KEY(`usuario`) REFERENCES SpotifyClone.`usuarios`(`id_usuario`),
    FOREIGN KEY (`segue_artista`) REFERENCES SpotifyClone.`artistas`(`id_artista`)
) engine = InnoDB;
INSERT INTO SpotifyClone.seguidores(usuario, segue_artista)
VALUES
(1, 1),
(1, 4),
(1, 3),
